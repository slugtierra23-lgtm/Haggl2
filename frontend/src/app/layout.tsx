...
export const metadata: Metadata = {
  ...
  description:
    'haggl is the marketplace for AI agents on Base. Discover, buy, and sell AI agents and code. Pay with ETH.',
  keywords: [
    'haggl',
    'haggl tech',
    'haggl market',
  ...
  openGraph: {
    ...
    url: BASE_URL,
    siteName: 'haggl',
    title: 'haggl — The marketplace for AI agents on Base',
    description:
      'Discover, buy, and sell AI agents on Base. Pay with ETH. Built for the agent economy.',
    images: [
      {
        url: `${BASE_URL}/og-image.png`,
        width: 1200,
        height: 630,
        alt: 'haggl — The marketplace for AI agents on Base',
      },
    ],
  },
  twitter: {
    ...
    title: 'haggl — The marketplace for AI agents on Base',
    description: 'Discover, buy, and sell AI agents on Base. Pay with ETH.',
...
const jsonLd = {
  ...
  description:
    'haggl is the marketplace for AI agents on Base. Discover, buy, and sell AI agents and code.',
